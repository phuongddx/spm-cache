...
- [ ] Extend `spec/lockfile_enrichment_spec.rb` + `spec/lockfile_spec.rb` — the derived binary-target flag, its invalidation with `products[]`, and the binary-backed name-set reader (planner's Q1 option-1 decision)
