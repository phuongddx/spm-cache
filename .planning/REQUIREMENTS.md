...
- [x] **TEST-03**: The v0.2.x edge-class fixture matrix does not regress — binary target (Class E), macro with narrow `swift-syntax`, vendored `.xcodeproj`, plugin-only, transitive-only, resource bundle, private Clang shim, product≠target rename
